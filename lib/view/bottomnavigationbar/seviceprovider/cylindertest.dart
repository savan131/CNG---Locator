...
class cylindertest extends StatefulWidget {
  const cylindertest({super.key});

  @override
  State<cylindertest> createState() => _cylindertestState();
}

CNGdata cngData = CNGdata();

class _cylindertestState extends State<cylindertest> {
  cylinderTest() async {
    var url = Uri.parse(
        'https://maps.googleapis.com/maps/api/place/textsearch/json?query=Cylinder%20Test%20in%20India&key=AIzaSyBQdEh3aocXi-dkH-661f1XP6YdsS_II2A');
